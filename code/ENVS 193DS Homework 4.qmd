...
#THIS DOES NOT SEEM RIGHT -- CHECK AGAIN 
```
7. 
```{r}
...
```
8. The ANOVA test is built on the same parametric base as linear regression models, so they have similar math and outputs. The main difference between this table and the summary table is the degrees of freedom. ???
